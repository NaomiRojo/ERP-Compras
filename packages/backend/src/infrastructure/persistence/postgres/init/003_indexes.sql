...
CREATE INDEX IF NOT EXISTS idx_usuarios_google_sub
  ON o_usuarios(google_sub);
...
CREATE INDEX IF NOT EXISTS idx_cxp_cuentas_compra
  ON cxp_cuentas_por_pagar(compra_id);

CREATE INDEX IF NOT EXISTS idx_cxp_cuentas_proveedor
  ON cxp_cuentas_por_pagar(proveedor_id);

CREATE INDEX IF NOT EXISTS idx_cxp_pagos_cuenta
  ON cxp_pagos_proveedor(cuenta_por_pagar_id);
